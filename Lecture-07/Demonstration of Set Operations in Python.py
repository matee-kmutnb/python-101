...
print("Is set_a a proper superset of set_b?:", set_a > set_b) # Output:
True
print("Is set_b a proper subset of set_a?:", set_b < set_a) # Output:
True
#
 # Equal Sets
...
print("Is set_b a subset of set_d and not equal?:", set_b <= set_d and
